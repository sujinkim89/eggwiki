  ...
  return (
    <section className={cn("relative min-h-[calc(630px-var(--header-height))] overflow-hidden pb-4", className)}>
      ...
      <div className="relative z-10 flex flex-col">
        <div>
          <div className="mx-auto flex min-h-[200px] max-w-[90vw] sm:max-w-[80vw] shrink-0 flex-col items-center justify-end gap-2 px-4 pt-0 pb-1 sm:px-16 lg:px-24">
            {subtitleTop && (
                  ...
                  testimonials={[
                    {
                      ...
                      src: "/eggfreezing/eggfreezing1.png",
                    },
                    {
                      ...
                      src: "/eggfreezing/eggfreezing2.jpeg",
                    },
                    {
                      ...
                      src: "/eggfreezing/eggfreezing3.png",
                    },
                  ]}
                  autoplay={false}
                  className="py-2"
